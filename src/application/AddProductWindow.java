...
public class AddProductWindow {
	...
	public static void display(){
		final TableView <Part>partTable = new TableView<Part>();
	    final ObservableList<Part> productPartsData = FXCollections.observableArrayList();
		...
		saveButton.setOnAction(e->{
			...
			else if (productPartsData.isEmpty()){
				errorMessage.setText("Please add parts to product");
			}
			else{
